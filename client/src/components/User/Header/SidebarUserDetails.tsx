        ...
        <ul>
          <li className="mb-2">
            <NavLink
              ...
              className={`flex items-center px-3 py-2.5 cursor-pointer border m-4 rounded-sm border-[#f1f1f1]  ${
                selectedItem === "tai-khoan"
