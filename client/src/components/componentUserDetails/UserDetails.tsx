...
const UserDetails = () => {
    ...
    const handleFileUpload = async ({ file }: any) => {
        ...
        try {
            ...
            setImageUrl(uploadResponse.data.secure_url);  // Lưu đường dẫn ảnh trả về
            setUserData({
                ...userData,
                avatar: uploadResponse.data.secure_url  // Cập nhật avatar trong userData
            });
        } catch (error) {
        ...
        <div className="flex justify-start border-2 rounded-sm bg-white h-[fit-content] w-full">
            ...
            <div className="flex-1 max-w-lg p-6 rounded-sm">
                ...
                <div className="flex justify-start mt-6">
                    <button
                        onClick={() => handlePasswordChange('old-password-value', 'new-password-value')}
