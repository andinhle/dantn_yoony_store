...
const AddProduct = () => {
  return (
    ...
    // <div className="container mx-auto p-6 w-[768px]">
    //     <div className="bg-white p-6 rounded-lg shadow-lg">
    //         <div className="bg-primary px-6 py-4 my-4 rounded-xl">
    //             <h2 className="text-xl font-semibold text-white">Thêm mới sản phẩm</h2>
    //         </div>
    //         <form>
    ...
    //             </div>
    //             <div className="gap-4 mb-4 border border-gray-300 bg-gray-100 rounded-md p-4">
    ...
    //                     <div className="w-full mb-4">
    //                         <label htmlFor="variant1" className="block text-sm font-medium text-gray-700">Chọn biến thể</label>
    ...
    //                     </div>
    //                     <div className="w-full mb-4">
    //                         <label htmlFor="variant2" className="block text-sm font-medium text-gray-700">Chọn giá trị</label>
